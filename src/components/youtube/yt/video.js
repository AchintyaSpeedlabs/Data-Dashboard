                    ...
                    <div className='video-container'>
                        <div>
                            ...
                            <div className='button-container'>
                                <Button className='button-video' target="_blank"  onClick={()=>{setModalIsOpen(false);setComment([])}} href="https://www.youtube.com/channel/UCoxIjrCyzbaTnOtZdhwxM7g" variant="primary" style={{backgroundColor:"#6d3088"}}>Visit</Button>
                                <Button className='button-video'  onClick={()=>{requestComment(props.video.id);setModalIsOpen(true);}} variant="primary" style={{backgroundColor:"#6d3088"}}>View Comments</Button>
                            ...
                            {/*Comment Modal*/}
                            <div>
                                <Modal ariaHideApp={false} isOpen={modelIsOpen} onRequestClose={()=>setModalIsOpen(false)} style={{overlay:{backgroundColor:'grey'},content:{width:"30%",height:"70%",margin:"auto",color:'black'}}}>
                                    <h1>Comments</h1>
                                    {currentPosts.map((v)=>{    
                                        return (
                                                <div style={{marginBottom:"2%"}} className='comment'>
                                                    <h4 style={{margin:"0px"}}>Name: {v.name}</h4>
                                                    <h4 style={{margin:"0px"}}>Comment: {v.comment}</h4>
                                                </div>
                                        )            
                                    })}
                                    {/*Comment Pagination*/}
                                    ...
                                    <div className='comment-button-container'>
                                        <Button  onClick={()=>{setModalIsOpen(false);setComment([])}} variant="primary" style={{backgroundColor:"#6d3088"}}>X</Button>
